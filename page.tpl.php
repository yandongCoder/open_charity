...
<div class="our-members">
  ...
  <div class="slider">
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/Cancer Research.png"/></div>
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/cc-standard-full-colour.png"/></div>
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/KopLogo.png"/></div>
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/ZingLogo.png"/></div>
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/ComicRelief.png"/></div>
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/KopLogo.png"/></div>
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/ZingLogo.png"/></div>
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/ComicRelief.png"/></div>
    <div><img data-lazy="<?php echo $base_path.$directory; ?>/images/Cancer Research.png"/></div>
